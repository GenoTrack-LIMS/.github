...
|----------------------------------------------------------------------------|-----------------------------------------------------------------|
| ➡️ **[genotrack-lims-api](https://github.com/GenoTrack-LIMS)**                             | Le serveur back-end RESTful qui gère toute la logique métier.  |
| ➡️ **[genotrack-lims-client](https://github.com/GenoTrack-LIMS/genotrack-lims-client)**                       | L'application cliente Angular qui fournit l'interface utilisateur. |
